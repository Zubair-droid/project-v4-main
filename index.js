...
if(resu)
{
  ...
  res.render("forum",{results: results});    
});
...
app.post("/submit", function(req, res){
  const submmittedName = req.body.username;
  const submittedRole = req.body.role;
  const submittedContact = req.body.contact;
  ...
  if (err) {
   console.log(err);
    ...
    if (foundUser) {
      ...
      foundUser.contact = submittedContact;
      foundUser.username = submmittedName;
      foundUser.role=submittedRole;
